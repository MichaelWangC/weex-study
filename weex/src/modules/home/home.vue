    ...
    data() {
        return {
            ...
            quickBtns: [
                [{
                index: 1,
                icon: require('../../assets/images/quickbtn/icon_quick_private.png'),
                title: '私募',
                titleColor: '#000000'
            },{
                index: 1,
                icon: require('../../assets/images/quickbtn/icon_quick_public.png'),
                title: '公募',
                titleColor: '#000000'
            },{
                index: 1,
                icon: require('../../assets/images/quickbtn/icon_quick_insurance.png'),
                title: '保险',
                titleColor: '#000000'
            },{
                index: 1,
                ...
                index: 1,
                icon: require('../../assets/images/home/icon_mine_unselected.png'),
                title: '公募',
                titleColor: '#000000'
            }]]
        }
